...
class Constants(BaseConstants):
    name_in_url = 'Confidence_study1e'
    ...
    index3 = 'player.index3'
    index4 = 'player.index4'
    index5 = 'player.index5'
    index6 = 'player.index6'
    index7 = 'player.index7'
    index8 = 'player.index8'
    index9 = 'player.index9'
    index10 = 'player.index10'

    trivial1 = 'player.trivial1'
    trivial2 = 'player.trivial2'
    trivial3 = 'player.trivial3'
    trivial4 = 'player.trivial4'
    trivial5 = 'player.trivial5'
    trivial6 = 'player.trivial6'
    trivial7 = 'player.trivial7'
    trivial8 = 'player.trivial8'
    trivial9 = 'player.trivial9'
    trivial10 = 'player.trivial10'

    text_a_certain = 'Money Machine A has one possible outcome only, always'
    text_b_certain = 'Money Machine B has one possible outcome only, always'
...
class Player(BasePlayer):
    ...
    trivial1 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial2 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial3 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial4 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial5 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial6 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial7 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial8 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial9 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")
    trivial10 = models.IntegerField(doc="check if the samples of the risky option only contains one outcome.")

    samplesizemma1 = models.IntegerField(doc="money machine a sample size")
    samplesizemma2 = models.IntegerField(doc="money machine a sample size")
    samplesizemma3 = models.IntegerField(doc="money machine a sample size")
    samplesizemma4 = models.IntegerField(doc="money machine a sample size")
    samplesizemma5 = models.IntegerField(doc="money machine a sample size")
    samplesizemma6 = models.IntegerField(doc="money machine a sample size")
    samplesizemma7 = models.IntegerField(doc="money machine a sample size")
    samplesizemma8 = models.IntegerField(doc="money machine a sample size")
    samplesizemma9 = models.IntegerField(doc="money machine a sample size")
    samplesizemma10 = models.IntegerField(doc="money machine a sample size")

    samplesizemmb1 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb2 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb3 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb4 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb5 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb6 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb7 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb8 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb9 = models.IntegerField(doc="money machine a sample size")
    samplesizemmb10 = models.IntegerField(doc="money machine a sample size")
    ...
    def getyoked(self):
        ...
        self.index1 = ast.literal_eval(yokinglist.get(Constants.index1))
        self.index2 = ast.literal_eval(yokinglist.get(Constants.index2))
        self.index3 = ast.literal_eval(yokinglist.get(Constants.index3))
        self.index4 = ast.literal_eval(yokinglist.get(Constants.index4))
        self.index5 = ast.literal_eval(yokinglist.get(Constants.index5))
        self.index6 = ast.literal_eval(yokinglist.get(Constants.index6))
        self.index7 = ast.literal_eval(yokinglist.get(Constants.index7))
        self.index8 = ast.literal_eval(yokinglist.get(Constants.index8))
        self.index9 = ast.literal_eval(yokinglist.get(Constants.index9))
        self.index10 = ast.literal_eval(yokinglist.get(Constants.index10))
        self.trivial1 = ast.literal_eval(yokinglist.get(Constants.trivial1))
        self.trivial2 = ast.literal_eval(yokinglist.get(Constants.trivial2))
        self.trivial3 = ast.literal_eval(yokinglist.get(Constants.trivial3))
        self.trivial4 = ast.literal_eval(yokinglist.get(Constants.trivial4))
        self.trivial5 = ast.literal_eval(yokinglist.get(Constants.trivial5))
        self.trivial6 = ast.literal_eval(yokinglist.get(Constants.trivial6))
        self.trivial7 = ast.literal_eval(yokinglist.get(Constants.trivial7))
        self.trivial8 = ast.literal_eval(yokinglist.get(Constants.trivial8))
        self.trivial9 = ast.literal_eval(yokinglist.get(Constants.trivial9))
        self.trivial10 = ast.literal_eval(yokinglist.get(Constants.trivial10))
        self.samplesizemma1 = ast.literal_eval(yokinglist.get("player.clicksmma1"))
        self.samplesizemma2 = ast.literal_eval(yokinglist.get("player.clicksmma2"))
        self.samplesizemma3 = ast.literal_eval(yokinglist.get("player.clicksmma3"))
        self.samplesizemma4 = ast.literal_eval(yokinglist.get("player.clicksmma4"))
        self.samplesizemma5 = ast.literal_eval(yokinglist.get("player.clicksmma5"))
        self.samplesizemma6 = ast.literal_eval(yokinglist.get("player.clicksmma6"))
        self.samplesizemma7 = ast.literal_eval(yokinglist.get("player.clicksmma7"))
        self.samplesizemma8 = ast.literal_eval(yokinglist.get("player.clicksmma8"))
        self.samplesizemma9 = ast.literal_eval(yokinglist.get("player.clicksmma9"))
        self.samplesizemma10 = ast.literal_eval(yokinglist.get("player.clicksmma10"))
        self.samplesizemmb1 = ast.literal_eval(yokinglist.get("player.clicksmmb1"))
        self.samplesizemmb2 = ast.literal_eval(yokinglist.get("player.clicksmmb2"))
        self.samplesizemmb3 = ast.literal_eval(yokinglist.get("player.clicksmmb3"))
        self.samplesizemmb4 = ast.literal_eval(yokinglist.get("player.clicksmmb4"))
        self.samplesizemmb5 = ast.literal_eval(yokinglist.get("player.clicksmmb5"))
        self.samplesizemmb6 = ast.literal_eval(yokinglist.get("player.clicksmmb6"))
        self.samplesizemmb7 = ast.literal_eval(yokinglist.get("player.clicksmmb7"))
        self.samplesizemmb8 = ast.literal_eval(yokinglist.get("player.clicksmmb8"))
        self.samplesizemmb9 = ast.literal_eval(yokinglist.get("player.clicksmmb9"))
        self.samplesizemmb10 = ast.literal_eval(yokinglist.get("player.clicksmmb10"))
    ...
    # to show underneath of the money machine when it is a safe machine
    def texta1(self):
        yokinglist = self.participant.vars['yokinglist']
        mma1 = ast.literal_eval(yokinglist.get(Constants.amounta1))
        return Constants.text_a_certain + ' ' + str(round(mma1)) + '¢.'

    def texta2(self):
        yokinglist = self.participant.vars['yokinglist']
        mma2 = ast.literal_eval(yokinglist.get(Constants.amounta2))
        return Constants.text_a_certain + ' ' + str(round(mma2)) + '¢.'

    def texta3(self):
        yokinglist = self.participant.vars['yokinglist']
        mma3 = ast.literal_eval(yokinglist.get(Constants.amounta3))
        return Constants.text_a_certain + ' ' + str(round(mma3)) + '¢.'

    def texta4(self):
        yokinglist = self.participant.vars['yokinglist']
        mma4 = ast.literal_eval(yokinglist.get(Constants.amounta4))
        return Constants.text_a_certain + ' ' + str(round(mma4)) + '¢.'

    def texta5(self):
        yokinglist = self.participant.vars['yokinglist']
        mma5 = ast.literal_eval(yokinglist.get(Constants.amounta5))
        return Constants.text_a_certain + ' ' + str(round(mma5)) + '¢.'

    def texta6(self):
        yokinglist = self.participant.vars['yokinglist']
        mma6 = ast.literal_eval(yokinglist.get(Constants.amounta6))
        return Constants.text_a_certain + ' ' + str(round(mma6)) + '¢.'

    def texta7(self):
        yokinglist = self.participant.vars['yokinglist']
        mma7 = ast.literal_eval(yokinglist.get(Constants.amounta7))
        return Constants.text_a_certain + ' ' + str(round(mma7)) + '¢.'

    def texta8(self):
        yokinglist = self.participant.vars['yokinglist']
        mma8 = ast.literal_eval(yokinglist.get(Constants.amounta8))
        return Constants.text_a_certain + ' ' + str(round(mma8)) + '¢.'

    def texta9(self):
        yokinglist = self.participant.vars['yokinglist']
        mma9 = ast.literal_eval(yokinglist.get(Constants.amounta9))
        return Constants.text_a_certain + ' ' + str(round(mma9)) + '¢.'

    def texta10(self):
        yokinglist = self.participant.vars['yokinglist']
        mma10 = ast.literal_eval(yokinglist.get(Constants.amounta10))
        return Constants.text_a_certain + ' ' + str(round(mma10)) + '¢.'

    def textb1(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb1 = ast.literal_eval(yokinglist.get(Constants.amountb1))
        return Constants.text_b_certain + ' ' + str(round(mmb1)) + '¢.'

    def textb2(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb2 = ast.literal_eval(yokinglist.get(Constants.amountb2))
        return Constants.text_b_certain + ' ' + str(round(mmb2)) + '¢.'

    def textb3(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb3 = ast.literal_eval(yokinglist.get(Constants.amountb3))
        return Constants.text_b_certain + ' ' + str(round(mmb3)) + '¢.'

    def textb4(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb4 = ast.literal_eval(yokinglist.get(Constants.amountb4))
        return Constants.text_b_certain + ' ' + str(round(mmb4)) + '¢.'

    def textb5(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb5 = ast.literal_eval(yokinglist.get(Constants.amountb5))
        return Constants.text_b_certain + ' ' + str(round(mmb5)) + '¢.'

    def textb6(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb6 = ast.literal_eval(yokinglist.get(Constants.amountb6))
        return Constants.text_b_certain + ' ' + str(round(mmb6)) + '¢.'

    def textb7(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb7 = ast.literal_eval(yokinglist.get(Constants.amountb7))
        return Constants.text_b_certain + ' ' + str(round(mmb7)) + '¢.'

    def textb8(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb8 = ast.literal_eval(yokinglist.get(Constants.amountb8))
        return Constants.text_b_certain + ' ' + str(round(mmb8)) + '¢.'

    def textb9(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb9 = ast.literal_eval(yokinglist.get(Constants.amountb9))
        return Constants.text_b_certain + ' ' + str(round(mmb9)) + '¢.'

    def textb10(self):
        yokinglist = self.participant.vars['yokinglist']
        mmb10 = ast.literal_eval(yokinglist.get(Constants.amountb10))
    ...
    def getmoneymachine1(self):
        ...
        self.amounta1 = ast.literal_eval(yokinglist.get(Constants.amounta1))
        self.amountb1 = ast.literal_eval(yokinglist.get(Constants.amountb1))
    ...
    def getmoneymachine2(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta2 = ast.literal_eval(yokinglist.get(Constants.amounta2))
        self.amountb2 = ast.literal_eval(yokinglist.get(Constants.amountb2))
    ...
    def getmoneymachine3(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta3 = ast.literal_eval(yokinglist.get(Constants.amounta3))
        self.amountb3 = ast.literal_eval(yokinglist.get(Constants.amountb3))
    ...
    def getmoneymachine4(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta4 = ast.literal_eval(yokinglist.get(Constants.amounta4))
        self.amountb4 = ast.literal_eval(yokinglist.get(Constants.amountb4))
    ...
    def getmoneymachine5(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta5 = ast.literal_eval(yokinglist.get(Constants.amounta5))
        self.amountb5 = ast.literal_eval(yokinglist.get(Constants.amountb5))
    ...
    def getmoneymachine6(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta6 = ast.literal_eval(yokinglist.get(Constants.amounta6))
        self.amountb6 = ast.literal_eval(yokinglist.get(Constants.amountb6))
    ...
    def getmoneymachine7(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta7 = ast.literal_eval(yokinglist.get(Constants.amounta7))
        self.amountb7 = ast.literal_eval(yokinglist.get(Constants.amountb7))
    ...
    def getmoneymachine8(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta8 = ast.literal_eval(yokinglist.get(Constants.amounta8))
        self.amountb8 = ast.literal_eval(yokinglist.get(Constants.amountb8))
    ...
    def getmoneymachine9(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta9 = ast.literal_eval(yokinglist.get(Constants.amounta9))
        self.amountb9 = ast.literal_eval(yokinglist.get(Constants.amountb9))
    ...
    def getmoneymachine10(self):
        yokinglist = self.participant.vars['yokinglist']
        self.amounta10 = ast.literal_eval(yokinglist.get(Constants.amounta10))
        self.amountb10 = ast.literal_eval(yokinglist.get(Constants.amountb10))
