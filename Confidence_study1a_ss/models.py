...
doc = """
Confidence Study1a Classroom
"""


class Constants(BaseConstants):
    name_in_url = 'Confidence_study1a_ss'
    ...
    mmacolor = 'lightblue'
    mmbcolor = 'orange'
    textcertaina = 'Points Machine A has one possible outcome only, always'
    textuncertaina = 'Here you see sample outcomes for Points Machine A.'
    textcertainb = 'Points Machine B has one possible outcome only, always'
    textuncertainb = 'Here you see sample outcomes for Points Machine B.'
...
class Group(BaseGroup):
    ...
    #         # get number of the players; could use len() to get the number of the elements in the list of self.get_players()
   ...
   # choice10 = models.CharField()
    ...
    def getmoneymachines(self):
       # Attributes of money machine pairs based on problem set long list dated 20.07.2017
        class Mm1(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €0 or €4'
                self.outcomebtext = 'Possible outcome €3'
        ...
        class Mm2(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €-4 or €0'
                self.outcomebtext = 'Possible outcome €-3'
        ...
        class Mm3(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €0 or €32'
                self.outcomebtext = 'Possible outcome €3'
        ...
        class Mm4(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €-10 or €0'
                self.outcomebtext = 'Possible outcome €-9'
                # self.outcomeaprob = 'Outcome probabilities 90% or 10%'
                # self.outcomebprob = 'Outcome probability 100%'
                self.amounta = -10
                self.amountb = -9
        ...
        class Mm6(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €2 or €0'
                self.outcomebtext = 'Possible outcome €1'
        ...
        class Mm7(object):
            def __init__(self):
                self.outcomeatext = 'Possible outcomes €-10 or €0'
                self.outcomebtext = 'Possible outcome €-5'
                # self.outcomeaprob = 'Outcome probabilities 50% or 50%'
                # self.outcomebprob = 'Outcome probability 100%'
                self.amounta = -10
                self.amountb = -5
