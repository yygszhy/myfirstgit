...
class Constants(BaseConstants):
    name_in_url = 'Confidence_study1d'
    ...
    mmacolor = 'lightblue'
    mmbcolor = 'orange'
    text_a_uncertain = 'Here you see sample outcomes for Money Machine A.'
    text_a_certain = 'Money Machine A has one possible outcome only, always'
    text_b_uncertain = 'Here you see sample outcomes for Money Machine B.'
...
class Player(BasePlayer):
    ...
    def getyoked(self):
        ...
        self.index1 = yokinglist.get(Constants.index1)
        self.index2 = yokinglist.get(Constants.index2)
        self.index3 = yokinglist.get(Constants.index3)
        self.index4 = yokinglist.get(Constants.index4)
        self.index5 = yokinglist.get(Constants.index5)
        self.index6 = yokinglist.get(Constants.index6)
        self.index7 = yokinglist.get(Constants.index7)
        self.index8 = yokinglist.get(Constants.index8)
        self.index9 = yokinglist.get(Constants.index9)
        self.index10 = yokinglist.get(Constants.index10)
        self.trivial1 = yokinglist.get(Constants.trivial1)
        self.trivial2 = yokinglist.get(Constants.trivial2)
        self.trivial3 = yokinglist.get(Constants.trivial3)
        self.trivial4 = yokinglist.get(Constants.trivial4)
        self.trivial5 = yokinglist.get(Constants.trivial5)
        self.trivial6 = yokinglist.get(Constants.trivial6)
        self.trivial7 = yokinglist.get(Constants.trivial7)
        self.trivial8 = yokinglist.get(Constants.trivial8)
        self.trivial9 = yokinglist.get(Constants.trivial9)
        self.trivial10 = yokinglist.get(Constants.trivial10)
...
# find good outcomes for each pair for display a button on HTML page
    def go1(self):
        yokinglist = self.participant.vars['yokinglist']
        probb1 = ast.literal_eval(yokinglist.get(Constants.proboptionb1))
        amounta1 = round(ast.literal_eval((yokinglist.get(Constants.mma1))))
        amountb1 = round(ast.literal_eval((yokinglist.get(Constants.mmb1))))
        if probb1 == 1.0:
            if self.bo1 == 0:
                return amounta1
            else:
    ...
    def go2(self):
        yokinglist = self.participant.vars['yokinglist']
        probb2 = ast.literal_eval(yokinglist.get(Constants.proboptionb2))
        amounta2 = round(ast.literal_eval((yokinglist.get(Constants.mma2))))
        amountb2 = round(ast.literal_eval((yokinglist.get(Constants.mmb2))))
        if probb2 == 1.0:
            if self.bo2 == 0:
                return amounta2
            else:
    ...
    def go3(self):
        yokinglist = self.participant.vars['yokinglist']
        probb3 = ast.literal_eval(yokinglist.get(Constants.proboptionb3))
        amounta3 = round(ast.literal_eval((yokinglist.get(Constants.mma3))))
        amountb3 = round(ast.literal_eval((yokinglist.get(Constants.mmb3))))
        if probb3 == 1.0:
            if self.bo3 == 0:
                return amounta3
            else:
    ...
    def go4(self):
        yokinglist = self.participant.vars['yokinglist']
        probb4 = ast.literal_eval(yokinglist.get(Constants.proboptionb4))
        amounta4 = round(ast.literal_eval((yokinglist.get(Constants.mma4))))
        amountb4 = round(ast.literal_eval((yokinglist.get(Constants.mmb4))))
        if probb4 == 1.0:
            if self.bo4 == 0:
                return amounta4
            else:
    ...
    def go5(self):
        yokinglist = self.participant.vars['yokinglist']
        probb5 = ast.literal_eval(yokinglist.get(Constants.proboptionb5))
        amounta5 = round(ast.literal_eval((yokinglist.get(Constants.mma5))))
        amountb5 = round(ast.literal_eval((yokinglist.get(Constants.mmb5))))
        if probb5 == 1.0:
            if self.bo5 == 0:
                return amounta5
            else:
    ...
    def go6(self):
        yokinglist = self.participant.vars['yokinglist']
        probb6 = ast.literal_eval(yokinglist.get(Constants.proboptionb6))
        amounta6 = round(ast.literal_eval((yokinglist.get(Constants.mma6))))
        amountb6 = round(ast.literal_eval((yokinglist.get(Constants.mmb6))))
        if probb6 == 1.0:
            if self.bo6 == 0:
                return amounta6
            else:
    ...
    def go7(self):
        yokinglist = self.participant.vars['yokinglist']
        probb7 = ast.literal_eval(yokinglist.get(Constants.proboptionb7))
        amounta7 = round(ast.literal_eval((yokinglist.get(Constants.mma7))))
        amountb7 = round(ast.literal_eval((yokinglist.get(Constants.mmb7))))
        if probb7 == 1.0:
            if self.bo7 == 0:
                return amounta7
            else:
    ...
    def go8(self):
        yokinglist = self.participant.vars['yokinglist']
        probb8 = ast.literal_eval(yokinglist.get(Constants.proboptionb8))
        amounta8 = round(ast.literal_eval((yokinglist.get(Constants.mma8))))
        amountb8 = round(ast.literal_eval((yokinglist.get(Constants.mmb8))))
        if probb8 == 1.0:
            if self.bo8 == 0:
                return amounta8
            else:
    ...
    def go9(self):
        yokinglist = self.participant.vars['yokinglist']
        probb9 = ast.literal_eval(yokinglist.get(Constants.proboptionb9))
        amounta9 = round(ast.literal_eval((yokinglist.get(Constants.mma9))))
        amountb9 = round(ast.literal_eval((yokinglist.get(Constants.mmb9))))
        if probb9 == 1.0:
            if self.bo9 == 0:
                return amounta9
            else:
    ...
    def go10(self):
        yokinglist = self.participant.vars['yokinglist']
        probb10 = ast.literal_eval(yokinglist.get(Constants.proboptionb10))
        amounta10 = round(ast.literal_eval((yokinglist.get(Constants.mma10))))
        amountb10 = round(ast.literal_eval((yokinglist.get(Constants.mmb10))))
        if probb10 == 1.0:
            if self.bo10 == 0:
                return amounta10
            else:
